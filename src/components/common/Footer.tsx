...
const Footer = () => {
  return (
    <footer className="bg-gray-200">
      {/* Top Section - Blue */}
      <div className="bg-[#4F46E5] rounded-t-3xl p-8 md:p-12">
          ...
          <div className="text-white mb-8 md:mb-0 md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white flex-grow"
              />
      ...
      {/* Bottom Section - Dark */}
      <div className="bg-[#1C1C1C] rounded-b-3xl p-8 md:p-12 text-white relative">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="hover:text-white transition-colors cursor-pointer">Runners</li>
                <li className="hover:text-white transition-colors cursor-pointer">Sneakers</li>
                <li className="hover:text-white transition-colors cursor-pointer">Basketball</li>
                <li className="hover:text-white transition-colors cursor-pointer">Outdoor</li>
                <li className="hover:text-white transition-colors cursor-pointer">Golf</li>
                <li className="hover:text-white transition-colors cursor-pointer">Hiking</li>
              </ul>
            </div>
          ...
          <div className="absolute bottom-0 right-0 text-white/5 text-[150px] md:text-[200px] font-black leading-none pointer-events-none">
            KICKS
          </div>
